...
//******************************************************************************
//
//  This is a real working piece of code that was used on the movie
//  Invincible to generate crowds. The processShot() function (at the end 
...
invincible.processShot("testdata/crowd_L13.parameters", 
                       invincible.silentChooseNBackend(,10000));
