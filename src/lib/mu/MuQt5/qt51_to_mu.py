...
htmlDir                  = "/Volumes/mash/Qt/5.1.0-rc1/clang_64/doc/"
...
baseHTML    = ["qt", "qobject" , "qwindow", "qsurface", "qwidget", 
               "qactionevent", "qcloseevent", "qcontextmenuevent",
               "qdragmoveevent", "qdragleaveevent", "qdropevent",
               "qenterevent", "qexposeevent", "qfileopenevent",
               "qfocusevent", "qhelpevent", "qhideevent", "qhoverevent",
               "qicondragevent", "qinputevent", "qinputmethodevent", "qinputmethodqueryevent",
               "qkeyevent", "qinputevent", "qmoveevent", "qpaintevent", "qresizeevent",
               "qscrollevent", "qscrollprepareevent", "qshortcutevent", "qshowevent",
               "qstatustipevent", "qtabletevent", "qtouchevent", 
               "qfont", "qsize", "qpoint", "qrect", "qicon",
               "qvariant", "qstandarditem", "qmodelindex", "qpixmap", "qdatetime",
               "qtime", "qdate", "qkeysequence", "qevent", "qregexp",
               ...
               "qitemselectionrange", "qitemselection", "qgradient", "qmargins",
               "qbrush", "qmatrix", "qtransform", "qpointf", "qpalette", "qnetworkcookie",
               "qtextstream", "qtextcodec", "qpainter", "qpainterpath", "qrectf", #"qstyleoption",
               "qtextcursor", "qtextoption", "qtextblock", "qclipboard",
               "qprocessenvironment", "qwebsettings", "qcursor",
               "qwebview", "qwebpage", "qwebframe", "qaction", "qactiongroup",
               "qbuttongroup", "qcompleter", "qstandarditemmodel", "qsvgwidget",
               "qapplication", "qguiapplication", "qtextdocument", "qwidgetaction", "qnetworkreply",
               "qabstractsocket", "qtcpsocket", "qlocalsocket", "qgestureevent", "qtcpserver",
               "qfiledevice",
               "qwindowstatechangeevent", "qnetworkcookiejar", "qnetworkaccessmanager"]
...
primitiveTypes  = set(["QSize", "QRect", "QRectF", "QPoint", "QPointF", "QRegExp",
                       "QIcon", "QPixmap", "QBitmap", "QImage", "QKeySequence",
                       "QColor", "QVariant", "QRegion", "QDateTime", "QTime", "QDate",
                       "QModelIndex", "QFont", "QUrl", "QByteArray", "QDataStream",
                       "QHostAddress", "QHostInfo", "QDir", "QFileInfo", "QImageWriter",
                       "QItemSelectionRange", "QItemSelection", "QBrush", "QGradient",
                       "QMatrix", "QTransform", "QConicalGradient", "QLinearGradient", 
                       "QRadialGradient", "QPalette", "QPainter", "QPainterPath",
                       "QMargins", "QNetworkCookie", "QProcessEnvironment",
                       "QTextCursor", "QTextOption", "QTextBlock", "QCursor"])

copyOnWriteTypes = [ "QBitArray", "QBitmap", "QBrush", "QByteArray", "QCache", 
                     "QContiguousCache", "QCursor", "QDir", "QFileInfo", "QFont", 
                     "QFontInfo", "QFontMetrics", "QFontMetricsF", "QGLColormap", 
                     "QGradient", "QHash", "QIcon", "QImage", "QKeySequence", "QLinkedList", 
                     "QList", "QLocale", "QMap", "QMultiHash", "QMultiMap", "QPainterPath", 
                     "QPalette", "QPen", "QPicture", "QPixmap", "QPolygon", "QPolygonF", 
                     "QQueue", "QRegExp", "QRegion", "QSet", "QSqlField", "QSqlQuery", 
                     "QSqlRecord", "QStack", "QString", "QStringList", "QTextBoundaryFinder", 
                     "QTextCursor", "QTextDocumentFragment", "QTextFormat", "QUrl", 
                     "QVariant", "QVector", "QX11Info", "QNetworkCookie", 
                     "QProcessEnvironment"]
...
pointerTypes = set(["QStandardItem", "QListWidgetItem", "QTreeWidgetItem", 
                    "QTableWidgetItem", "QEvent", "QResizeEvent", "QTextStream",
                    "QDragLeaveEvent", "QDragMoveEvent", "QDropEvent", "QCloseEvent",
                    "QDragEnterEvent", "QInputEvent", "QMoveEvent", "QPaintEvent",
                    "QShortcutEvent", "QShowEvent", "QTimerEvent", "QFocusEvent",
                    "QContextMenuEvent", "QKeyEvent", "QMouseEvent", "QTabletEvent",
                    "QWheelEvent","QHelpEvent", "QFileOpenEvent", 
                    "QHideEvent", "QHoverEvent", "QGestureEvent", 
                    "QTextCodec", "QWebSettings",
                    "QWindowStateChangeEvent"])
#"QTouchEvent", 

notInheritableTypes = set(["QNetworkReply", "QWebFrame", "QIODevice", "QClipboard"])
...
includeClasses = set([
    ...
    "QEventLoop",             "QGroupBox",        "QIODevice",           "QDateTime",
    ...
    "QConicalGradient",       "QLinearGradient",  "QRadialGradient",     "QTime",
    "QPointF",                "QPalette",         "QRectF",              "QDate",
    "QNetworkAccessManager",  "QNetworkReply",    "QKeySequence",        "QEvent",
    "QResizeEvent",           "QDragLeaveEvent",  "QDragMoveEvent",      "QDropEvent",
    "QDragEnterEvent",        "QInputEvent",      "QMoveEvent",          "QPaintEvent",
    "QShortcutEvent",         "QShowEvent",       "QTimerEvent",         "QFocusEvent",
    "QGestureEvent",          "QWheelEvent",      "QTabletEvent",        "QMimeData",
    "QContextMenuEvent",      "QKeyEvent",        "QMouseEvent",         "QWindowStateChangeEvent",
    "QHideEvent",             "QHoverEvent",      "QHelpEvent",          "QFileOpenEvent",
    "QRegExp",                "QTextCursor",      "QTextOption",         "QTextBlock",
    "QMargins",               "QCloseEvent",      "QClipboard",          "QNetworkCookie",
    "QTextCodec",             "QTextStream",      "QTextBrowser",        "QNetworkCookieJar",
    "QProcessEnvironment",    "QWebSettings",     "QCursor",             "QFileDevice",
    "QGuiApplication",
    #"QStyleOption",           "QStyle",
...
exclusionMap = {
    ...
    "QImage::QImage" : [('QImage', '', [('fileName', 'const char *', None), 
                                        ('format', 'const char *', '0')], '', False)
                        ],
    ...
    "QByteArray::number" : [('number', '', [('n', 'uint', None), ('base', 'int', '10')], 'QByteArray', False)],
    ...
    "QFileInfo::setFile" : [('setFile', '', [('file', 'const QFile &', None)], 'void', False)],
    "QFileInfo::operator!=" : [('operator!=', 'const', [('fileinfo', 'const QFileInfo &', None)], 'bool', False)],
    "QFileInfo::operator==" : [('operator==', 'const', [('fileinfo', 'const QFileInfo &', None)], 'bool', False)],
    ...
    "QFont::QFont" : [('QFont', '', [('font', 'const QFont &', None), 
                                     ('pd', 'QPaintDevice *', None)], '', False)],
    ...
    "QStyle::polish" : [('polish', '', [('palette', 'QPalette &', None)], 
                         'virtual void', False)],
    ...
    "QTextStream::QTextStream" : [('QTextStream', '', [('string', 'QString *', None), ('openMode', 'QIODevice::OpenMode', 'QIODevice::ReadWrite')], '', False),
                                  ('QTextStream', '', [('array', 'QByteArray *', None), ('openMode', 'QIODevice::OpenMode', 'QIODevice::ReadWrite')], '', False),
                                  ('QTextStream', '', [('array', 'const QByteArray &', None), ('openMode', 'QIODevice::OpenMode', 'QIODevice::ReadOnly')], '', False)],
...
def convertTo(expr, ktype):
    ...
    if convertToMap.has_key(ktype):
        ...
        if mtype in primitiveTypes:
            return "makeqtypelist<%s, %sType>(c,%s,\"qt.%s\")" % (mtype, mtype, expr, mtype)
        else:
        ...
        for i in self.enums:
            ...
            for p in self.inherits:
                if not p in api.classes.keys():
                    print "WARNING:", p, "not in classes - can't make fullEnumName in", self.name
                else:
                    parent = api.classes[p]
...
class MuFunction:
    ...
    def symbolDeclaration(self):
        ...
        out = "new %s(c, \"%s\", %s, %s, Compiled, %s, Return, \"%s\", " % \
                (ftype, self.name, self.node, flags, self.compiled, rtype)
        if self.args:
            out += "Parameters, "
            for (aname, atype, aval) in self.args:
                ...
                if aval != None and doesFunctionAllowDefaultValues(self.muclass, self.name):
                    if atype == "int":
    ...
    def compiledFunction(self):
        ...
        if self.isconstructor:
            ...
            if self.ismember:
                ...
                if muclass.primitivetype:
                    ...
                    if inheritable and \
                           self.virtual and \
                           not self.purevirtual:
                           #not self.isprotected \
                        # only if its public 
                        if self.isprotected:
                            expr = "((MuQt_%s*)arg0)->%s_pub_parent(" % (muclass.name, self.name)
                            altexpr = "((MuQt_%s*)arg0)->%s_pub(" % (muclass.name, self.name)
                        else:
        ...
        rtypePaintDevice = muapi.isAByName(self.rtype, "QPaintDevice") and \
                           not self.rtype.split(".")[-1] in pointerTypes and \
                           not self.rtype.split(".")[-1] in primitiveTypes 
        rmaker = None
            ...
            if self.isconstructor:
                ...
                if altexpr:
                    ...
                    if needsDeref:
                        if rmaker:
                            body += "%s<%sType>(c, %s, \"%s\")" \
                                % (rmaker, self.rtype, expr, "qt." + self.rtype)
                            body += " : %s<%sType>(c, %s, \"%s\");\n" \
                                % (rmaker, self.rtype, altexpr, "qt." + self.rtype)
                        else:
...
class MuClass:
    ...
    def __init__(self, api, qtnamespace, muapi):
        ...
        self.castoperators = []
        self.enums         = []
        self.F_trans       = lambda f: not f.failed and not f.isprop and \
                                (self.inheritable or not f.isprotected)
        self.funcCount     = {}
        self.inherits      = []
        self.inheritedby   = []
        self.muapi         = muapi
        ...
        if not self.primitivetype and not self.pointertype and not self.isinterface:
            ...
            for ft in self.inheritedVirtuals:
                ...
                fhere = self.name + "::" + f[0]
                if not self.hasFunction(f[0]) and \
                   not isFunctionExcluded(qtnamespace, f):
        ...
        for f in qtnamespace.staticfuncs:
            ...
            exclude = isFunctionExcluded(qtnamespace, f)
            if not exclude:
                self.statics.append(MuFunction(api, self, f, False, 
                                               f in qtnamespace.protectedfuncs,
                                               False))
    ...
    def assembleIncludes(self, cpplines):
        ...
        for t in itypes:
            cpplines.insert(endinclude+1, '#include "%s.h"\n' % t)
        ...
        if not (self.name in noHFileOutput):
            ...
            while True:
                ...
                if line == "":
                    ...
                    if (self.inheritable):
                        hlines.append("inline ClassInstance* %sType::cachedInstance(const %sType::MuQtType* obj) { return obj->_obj; }\n" % (name, name))
                    else:
                        hlines.append("inline ClassInstance* %sType::cachedInstance(const %sType::MuQtType* obj) { return 0; }\n" % (name, name))
...
class MuAPI:
    ...
    def __init__(self, api):
        ...
        for k in self.classes.keys():
            ...
            c.inheritable = (isQObject or isQLayoutItem or isQPaintDevice) \
...
class QtDocParser(SGMLParser):
    ...
    def handle_data(self, data):
        ...
        if self.h3:
            ...
            if self.intitle:
                ...
                self.intypes = False
                if data == "Public Functions" or \
                   data == "Reimplemented Public Functions":
                    self.bucket = self.public
                    self.functable = True
                elif data == "Protected Functions" or \
                     data == "Reimplemented Protected Functions":
    ...
    def convertFunctions(self):
        ...
        self.qtnamespace.functions      = self.qtnamespace.publicfuncs + \
                                          self.qtnamespace.protectedfuncs
...
def findHTMLinDocTree(rootname):
    for d in ["qtcore", "qtgui", "qtwidgets", "qtnetwork", "qtopengl", "qtconcurrent", "qtwebkit", "qtsvg"]:
