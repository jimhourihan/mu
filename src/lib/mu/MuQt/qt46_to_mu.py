...
htmlDir                  = "/Users/jimh/doc/qt46/doc/html/"
...
includeClasses = set([
    ...
    "QMargins",               "QCloseEvent",      "QClipboard",
    "QTextCodec",             "QTextStream",      "QTextBrowser",
    #"QStyleOption",           "QStyle",
...
if outputModuleParts:
    ...
    if muapi.classes.has_key(""):
        c = muapi.classes[""]
        message("INFO: output files for Global")
        c.outputSourceFiles()
